######目的：利用Cottrazm识别LUAD空转样本PT10_T1的肿瘤边界，并比较CNV和肿瘤评分
######作者：申奥
######日期：2024-07-21
...
TumorSTn <- BoundaryDefine(TumorST = TumorST, MalLabel = c(5,6,7,8), OutDir = OutDir, Sample = Sample)
