######目的：利用Cottrazm识别LUAD空转样本PT24_T1的肿瘤边界，并比较CNV和肿瘤评分
######作者：申奥
######日期：2024-07-22
...
# 1.PT24_T1样本Cottrazm边界识别----
## 1.1 识别边界----
InDir <- "1.data/SP/PT24_T1/"
Sample = "PT24_T1"
...
TumorSTn <- BoundaryDefine(TumorST = TumorST, MalLabel = c(5,6,8), OutDir = OutDir, Sample = Sample)
