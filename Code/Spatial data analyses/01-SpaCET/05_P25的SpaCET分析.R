...
p1 <- SpaCET.visualize.spatialFeature(
  ...
  #       title = element_text(size = 12))
p1
ggsave(filename = "13.SpaCET/P25_T1/Malignant.pdf", p1, height = 4, width = 4.5, dpi = 300)
...
p2 <- SpaCET.visualize.spatialFeature(SpaCET_obj, spatialType = "Interface", 
  ...
  #       title = element_text(size = 12))
p2
ggsave(filename = "13.SpaCET/P25_T1/Interface.pdf", p2, height = 4, width = 4.5, dpi = 300)
...
ggsave(filename = "13.SpaCET/P25_T1/Malignant_state_A.pdf", msa, height = 4, width = 4.5, dpi = 300)
ggsave(filename = "13.SpaCET/P25_T1/Malignant_state_B.pdf", msb, height = 4, width = 4.5, dpi = 300)
...
# 7.保存----
save(SpaCET_obj, file = "13.SpaCET/P25_T1/P25_T1_SpaCET_obj.RData")
